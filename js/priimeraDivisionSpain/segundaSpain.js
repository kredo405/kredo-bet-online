...
function getMatches(league_id, seasonStart, seassonEnd) {
    ...
    axios.request(options).then(function (response) {
        ...
        let matchesOfDataPremierLeagueEng = response.data.api.fixtures.filter(el =>
            el.league.name == "Segunda Division" && el.league.country == "Spain"
        )
        matchesOfDataPremierLeagueEng.forEach(function (el) {
